...
export const INTL_COUNTRIES: FlagCountry[] = [
  ...
  { code: "JM", name: "Jamaica", continent: "America" },
  { code: "BB", name: "Barbados", continent: "America" },
  { code: "BS", name: "Bahamas", continent: "America" },
  { code: "TT", name: "Trinidad and Tobago", continent: "America" },
  { code: "AG", name: "Antigua and Barbuda", continent: "America" },
  { code: "GD", name: "Grenada", continent: "America" },
  // Asia
